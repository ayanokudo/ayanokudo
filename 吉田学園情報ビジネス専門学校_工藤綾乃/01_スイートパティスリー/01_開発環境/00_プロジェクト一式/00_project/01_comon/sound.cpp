...
CSound::PARAM CSound::m_aParam[SOUND_LABEL_MAX] = {
    ...
    { "data/BGM/bgm001.wav", -1 },		// ステージBGM
    { "data/BGM/bgm002.wav", 0 },		// リザルト画面のBGM
    { "data/BGM/bgm004.wav", -1 },		// ボスのBGM
    { "data/BGM/bgm005.wav", -1 },		// ランキング画面
    { "data/BGM/bgm003.wav", -1 },       // チュートリアル
    { "data/SE/hit002.wav", 0 },		// 発射音
    { "data/SE/beam000.wav", 0 },		// ビーム発射音
    { "data/SE/hit000.wav", 0 },		// ヒット音
    { "data/SE/explosion000.wav", 0 },	// 爆発音
    { "data/SE/decide000.wav ",0 },		// 決定音
    { "data/SE/item000.wav ",0 },		// アイテム取得
    { "data/SE/powup.wav ",0 },		    // パワーアップ
};
